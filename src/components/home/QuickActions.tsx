...
const actions: QuickAction[] = [
  ...
  { icon: Clock, label: "Alarms", gradient: "gradient-mint", delay: 100 },
  { icon: Receipt, label: "Split Bill", gradient: "gradient-coral", delay: 150 },
  { icon: Cloud, label: "Storage", gradient: "gradient-primary", delay: 200 },
