import { Plus, X, Receipt, ListTodo, Clock, Camera, MessageCircle } from "lucide-react";
    ...
    <>
      <div className="fixed bottom-24 right-4 z-40">
        ...
        <button
          ...
          className={cn(
            "w-14 h-14 rounded-2xl flex items-center justify-center shadow-glow transition-all duration-300 hover:scale-105 active:scale-95",
